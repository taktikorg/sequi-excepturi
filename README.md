...
to set up a service worker you have to basically copy [the example](https://github.com/taktikorg/sequi-excepturi/tree/master/example/sw.js) and register it:
